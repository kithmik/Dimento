...
@section('content')
    ...
    <div class="row">
        <div class="col-md-6 mx-auto">
            ...
            <form  action="{{ route('object.store') }}" method="post" enctype="multipart/form-data" id="obj-create-form" name="obj-create-form">
                {{ csrf_field() }}
                <!--Rotating card-->
                    ...
                    <div id="card-1" class="card-rotating effect__click m-1 p-1 pb-2" style="display: inline-block;">
                        ...
                        <!--Content-->
                            <div class="card-body">
                                ...
                                <br>
                                <div class="" id="extra-files-div">

                                </div>


                                <div class="row">
                                    <div class="col-md-12 pull-right mr-auto text-right">
                                        <button type="button" id="add-more-btn" class="btn btn-outline-default waves-effect btn-sm">
                                            Add More Objects
                                        </button>
                                    </div>
                                </div>
                        ...
                        <div class="face back">
                            ...
                            <!--Content-->
                            {{--<h4>About me</h4>--}}
                            <h4>Say something About this Model</h4>
                            <hr>
                            {{--<p>
                            ...
                            <div class="col-md-12">
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="md-form">
                                            ...
                                            <input type="text" id="title" name="title" class="form-control" length="150">
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="md-form">
                                            <input type="submit" class="btn btn-outline-elegant btn-rounded" name="submit" id="submit">
                                        </div>
                                    </div>
                                </div>
...
//               card.height(card.height()-extra_ele_div.height());
               ...
               var html_eles = '<div class="appended-div" data-id="'+i+'"> <div class="row"> <div class="card z-depth-1 hoverable"> <div class="card-body"> <div class="row"> <div class="col-md-10"> <div class="row"> <div class="col-md-12"> <div class="file-field"> <div class="btn btn-elegant btn-sm"> <span>Choose A 3D object file</span> <input type="file" name="objects[]" id="objects-'+i+'"> </div> <div class="file-path-wrapper"> <input class="file-path validate" type="text" placeholder="3D model object files"> </div> </div> </div> </div> <div class="row"> <div class="col-md-12"> <div class="file-field"> <div class="btn btn-elegant btn-sm"> <span>Choose A Texture</span> <input type="file" name="textures[]" id="texture-'+i+'"> </div> <div class="file-path-wrapper"> <input class="file-path validate" type="text" placeholder=".jpg, .png"> </div> </div> </div> </div> </div> <div class="col-md-2"> <div class=" text-right"> <button type="button" class="btn btn-flat close-btn" data-id="'+i+'"> <i class="fa fa-window-close"></i> </button> </div> </div> </div> </div> </div> </div> <br> </div>  ';
