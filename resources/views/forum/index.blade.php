...
<div class="container-fluid">
    <a href="{{route('post.create')}}" type="button" class="btn btn-outline-elegant waves-effect btn-sm"> <i
                class="fa fa-plus-circle" aria-hidden="true"></i> Create</a>
    <div class="row content">
        <div class="col-sm-3 sidenav">
            ...
            <ul class="nav nav-pills nav-stacked">
                <ul>
                    ...
                    <li><a href="#section3">My uploaded 3D model is not rotating. Can anyone help me please?</a></li>
                </ul>
            </ul>
            <br>
            ...
            <div class="input-group">
                ...
                <a href="#" type="button" class="btn btn-outline-elegant waves-effect btn-sm"> <i
                            class="fa fa-search prefix" aria-hidden="true"></i>Search</a>
            </div>
        ...
        <div class="col-sm-6">
            ...
            <div class="post-description">
                <p>Ok so I have a project for my high school speech class were I have to interview someone who has the
                    same job that I want when I get older so if anyone here does like 3D modeling for games I would like
                    you to please answer these basic questions.
                    ...
                    2. Do you usually work on one project by yourself or do you work on one thing with multiple
                    people?<br>
                    3. Do you specialize and work on one type of model (characters, basic objects, scenery, etc) or do
                    you work on anything assigned?</p>
            ...
            <form action="{{ route('post.store') }}" methods="post">
                ...
                <div class="form-group">
                    <textarea class="form-control" name="body" id="new-post" rows="10"
                              placeholder="Enter your new post"></textarea>
                </div>
